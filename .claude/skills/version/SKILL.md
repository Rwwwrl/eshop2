...
5. If the user asked to **bump**: ask which packages to bump and by what level (patch/minor/major), then apply the changes. After bumping libs, also update all service `myeshop-libs` constraints to match.
